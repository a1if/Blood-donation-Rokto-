package com.firstapplication.rokto.adapter;
...
import com.firstapplication.rokto.Email.JavaMailApi;
import com.firstapplication.rokto.model.User;
import com.firstapplication.rokto.R;
...
public class UserAdapter  extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.lastdonate.setText(user.getDonationtime());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView type, userName, userEmail, phoneNumber, bloodGroup,lastdonate;

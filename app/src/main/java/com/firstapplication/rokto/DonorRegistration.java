...
public class DonorRegistration extends AppCompatActivity {
    ...
    private TextInputEditText registerFullName, registerNIDNumber,
            registerPhoneNumber, registerEmail, registerPassword,lastDonation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String nid = registerNIDNumber.getText().toString().trim();
                final String phoneNumber = registerPhoneNumber.getText().toString().trim();
                final String bloodGroup = bloodGroupsSpinner.getSelectedItem().toString();
                final String donation = lastDonation.getText().toString().trim();
                ...
                if (TextUtils.isEmpty(donation)){
                    registerFullName.setError("Donation time is required");
                    return;
                }
                if (TextUtils.isEmpty(nid)){
                    registerNIDNumber.setError("Id Number is required!");
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                userInfo.put("donationtime", donation);
